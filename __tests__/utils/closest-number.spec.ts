...
describe('Closest number', () => {
  ...
  it('should return 10 for 8', () => {
    expect(findClosest(POSSIBLE_CE, 8)).toBe(10);
  });
  ...
  it('should return 3 for 3.5', () => {
    expect(findClosest(POSSIBLE_CE, 3.5)).toBe(3);
  });
  it('should return 1 for 1.5', () => {
    expect(findClosest(POSSIBLE_CE, 1.5)).toBe(2);
  });
  it('should return 5 for 4', () => {
    expect(findClosest(POSSIBLE_CE, 4)).toBe(5);
  });
});